      ...
      <div>
        ...
        <div className='welcome'>
          ...
          <div className='ten'>
            ...
            <input class="form-control" id='foorm' type="text" placeholder="Full Name" aria-label="default input example"/>
          ...
          <div className='ndd'>
            <p>Already have an account? <Link to='/Log' className='kkkk'>click here</Link></p>
          </div>
        </div>
      </div>
    )
